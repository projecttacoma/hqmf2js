...
root.map = function(record, population, denominator, numerator, exclusion, denexcep, msrpopl, msrpoplex, observ, occurrenceId, isContinuousVariable, stratification, variables) {
  ...
  if (isContinuousVariable) {
    ...
    value = calculate(record, population, denominator, numerator, exclusion, denexcep, occurrenceId, value, stratification, variables)
  }
...
root.calculate = function(record, population, denominator, numerator, exclusion, denexcep, occurrenceId, value, stratification, variables) {
